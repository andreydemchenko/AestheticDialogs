...
class AestheticDialog {
    ...
    class Builder(
        ...
        private var image: byte[] = {0, 0, 0, 0, 0, 0, 0, 0}
        // Optional features
        ...
        /**
         * Set the image of the dialog
         *
         * @param image in milliseconds
         * @return this, for chaining.
         */
        @NonNull
        fun setImage(image: byte[]): Builder {
            this.image = image
            return this
        }
            ...
            when (dialogStyle) {
                ...
                DialogStyle.FLASH -> {
                    ...
                    if (dialogType == DialogType.CUSTOM) {
                        dialogFrame.setBackgroundResource(R.drawable.rounded_green_gradient_bg)
                        icon.setImageBitmap(BitmapFactory.decodeByteArray(image, 0, image.size);)
                    } else {
